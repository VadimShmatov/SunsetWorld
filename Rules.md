...
*Максимальная воля* определяет запас воли персонажа. Вычисляется как $1 + (ИНТ + ХАР) / 3$. Персонаж может потратить 1 волю, чтобы добавить d6 к броску при проверке характеристики. Для использования некоторых способностей также требуется воля. Вся воля восстанавливается в конце долгого отдыха.
...
<details>
  ...
  1. Некачественная сборка
  -1 ко всем проверкам при использовании устройства.

  2. Перегрев компонентов
  После 2 использований за сцену при каждом следующем использовании проходите проверку удачи. При провале устройство ломается.

  3. Повышенный износ
  В конце сцены, если вы использовали устройство, пройдите проверку удачи. При провале устройство ломается.

  4. Непредсказуемая работа
  Раз в день устройство может не сработать или внезапно отключиться.

  5. Чувствительность к вибрациям
  Устройство ломается, если вы получаете урон вибрацией.

  6. Сложное в использовании
  Для использования устройства требуется интеллект d10.
...
Годы адаптации к сокрушительной гравитации Новой Европы превратили его колонистов в настоящих титанов. Сила персонажа увеличена на 1 ступень, и максимальное здоровье увеличено на 1.
...
Суровые условия и постоянная необходимость прятаться от военных вынуждают жителей Эостера разбираться в военном деле. Ловкость персонажа увеличена на 1 ступень, и он получает бесплатную специализацию военного (не влияет на стоимость других специализаций).
...
Благодаря боевому опыту вы отточили способность находить уязвимые места противников. Используя любом образом волю при атаке, вы наносите +1 урон в случае успеха. Если вы убиваете или выводите из строя противника, используя эту способность, то получаете воодушевление. Воодушевленный персонаж добавляет d6 ко всем своим броскам до первого провала.
...
Вы привыкли использовать разнообразные возможности, чтобы добиваться успеха во всем, за что возьметесь. Раз в сцену, добившись критического успеха, вы получаете воодушевление. Воодушевленный персонаж добавляет d6 ко всем своим броскам до первого провала.
...
Вы используете силу личности и ораторское искусство, чтобы воодушевить союзника. Воодушевленный персонаж добавляет d6 ко всем своим броскам до первого провала.
...
<details>
  ...
  + Токсичные иглы
    Попадание из игломета отравляет противника. В начале каждого хода он проходит проверку выносливости (сл. 6). При провале он получает 1 ед. урона, при успехе отравление снимается
...
<details>
  ...
  После атаки все противники на средней дистанции должны либо потратить 2 ед. воли, либо бежать от вас следующий ход
...
*Расходный материал, аналоговое устройство*
...
<details>
  ...
  + Длительный эффект
    После введения дает защиту от ядов и болезней до продолжительного отдыха
...
<details>
  ...
  + Система восстановления
    Устройство поглощает элементы из воздуха и воспроизводит тушащий состав, восстанавливая 1 заряд после каждого продолжительного отдыха
...
Ярость переполняет персонажа во время боя. Всякий раз, когда он получает урон, он также получает воодушевление. Воодушевленный персонаж добавляет d6 ко всем своим броскам до первого провала.
...
Сказать, что природа обделила вашего персонажа красотой, значил бы ничего не сказать. Персонаж настолько уродлив, что получает постоянный штраф -2 к харизме, а противоположный пол от него вообще шарахается.
